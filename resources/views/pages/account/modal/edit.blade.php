    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header flex-stack align-items-center">
                <div class="fs-2 fw-bold">Edit User</div>
            ...
            <form class="modal-body pt-10 pb-15 px-lg-17" id="form_edit_account">
                <div class="px-3" style="max-height: 400px; overflow-y: auto;">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <select name="role" class="form-select form-select-solid" data-control="select2" required
                            data-hide-search="true" data-placeholder="Role" data-select2-parent="#modal_edit_account">
...
<script>
    $(document).ready(function() {
        $('#form_edit_account').on('submit', function(e) {
            ...
            $('#form_edit_account [type="submit"]').attr('disabled', true);
            $('#form_edit_account [type="submit"]').html(
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#form_edit_account [type="submit"]').attr('disabled', false);
                    $('#form_edit_account [type="submit"]').html('Simpan')
                    $('#modal_edit_account').modal('hide');

                    $('#form_edit_account').trigger('reset');
                    accountTable?.draw();
                },
