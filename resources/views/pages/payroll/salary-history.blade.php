...
<div class="bg-white min-vh-100 py-4">
    <div class="container">
                        ...
                        <tbody class="text-center">
                            @forelse($salaryHistory as $salary)
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($salary->periodeGaji)->format('F Y') }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="15" class="text-muted">Tidak ada riwayat gaji</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <form method="GET" action="{{ route('salary.logs.ajax') }}" class="row gy-2 gx-3 align-items-center mb-4">
            <div class="col-md-3">
