...
<head>
    ...
    <title>Simbanding - @yield('title') </title>
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{asset('src/assets/images/logoitk.png')}}" alt="homepage" class="dark-logo"
                                    width="40" />
                                <!-- Light Logo icon -->
                                <img src="{{asset('src/assets/images/logoitk.png')}}" alt="homepage" class="light-logo"
                                    width="40" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('src/assets/images/simbanding.png')}}" alt="homepage" class="dark-logo"
                                    width="150" />
                                <!-- Light Logo text -->
                                <img src="{{asset('src/assets/images/simbanding.png')}}" class="light-logo"
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="test"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="datauser"
                                aria-expanded="false"><i class="fas fa-user-circle" class="feather-icon"></i><span
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 id="lblGreetings" class="page-title text-truncate text-dark font-weight-medium mb-1"></h3>
                        <script>
                            var myDate = new Date();
                            ...
                            //document.getElementById('lblGreetings2').innerHTML = '</b> {{ Auth::user()->name }}';
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('src/assets/images/logoitk.png')}}">
    <title>Sibanding - @yield('title') </title>
    <!-- Custom CSS -->
    <link href="{{asset('src/assets/extra-libs/c3/c3.min.css')}}" rel="stylesheet">
    <link href="{{asset('src/assets/libs/chartist/dist/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('src/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="dashboard">
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('src/assets/images/sibanding.png')}}" alt="homepage" class="dark-logo"
                                    width="150" />
                                <!-- Light Logo text -->
                                <img src="{{asset('src/assets/images/sibanding.png')}}" class="light-logo"
                                    alt="homepage" width="150" />
                            </span>
                        </a>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <form action="{{ route('logout') }}" method="POST">
                                    ...
                                    <button class="dropdown-item" ><i data-feather="power"
                                        class="svg-icon mr-2 ml-1" >  </i>Logut</button>
                                </form>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{url('/data')}}" aria-expanded="false"><i
                                    data-feather="tag" class="feather-icon"></i><span class="hide-menu">Data
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="index.html"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                                    class="hide-menu">Null</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="index.html"
                                aria-expanded="false"><i class="fas fa-user-circle" class="feather-icon"></i><span
                                    class="hide-menu">Data User</span></a></li>
        ...
        <!-- ============================================================== -->
        <footer class="footer text-center text-muted">
            All Rights Reserved by ITK. Designed and Developed by <a href="https://instagram.com/irwanripansyah"
                target="_blank">Irwan Ripansyah</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="src=" {{asset('src')}}../assets/extra-libs/c3/c3.min.js"> </script> <script src="src="
        {{asset('src')}}../assets/libs/chartist/dist/chartist.min.js"> </script> <script src="src="
        {{asset('src')}}../assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"> </script> <script
        src="src=" {{asset('src')}}../assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"> </script> <script
        src="src=" {{asset('src')}}../assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"> </script> <script
        src="src=" {{asset('src')}}../dist/js/pages/dashboards/dashboard1.min.js"> </script> --}} </body> </html> --}} --}}
